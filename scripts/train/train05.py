...
def save_metrics(cfg, total_params, trainable_params, trainable_ratio, result, train_time):
    ...
    row = {
        ...
        "method": cfg.get("method", "adalora_strict"),
        "rank": cfg["target_r"],
...
def train(cfg, model, train_loader, eval_loader, device):
    ...
    return result, train_time, rank_rows, log_rows
...
def run():
    ...
    result, train_time, rank_rows, log_rows = train(
        cfg,
        model,
        train_loader,
        eval_loader,
